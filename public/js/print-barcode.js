...
!(function (t) {
                        ...
                        },
                        {
                            ...
                            value: function (t, n, r) {
                                ...
                                if (t[0] >= 200) {
                                    ...
                                    void 0 !== a
                                        ? (o = e.next(t, n + 1, a))
                                        : ((r !== u.SET_A && r !== u.SET_B) || i !== u.SHIFT || (t[0] = r === u.SET_A ? (t[0] > 95 ? t[0] - 96 : t[0]) : t[0] < 32 ? t[0] + 96 : t[0]), (o = e.next(t, n + 1, r)));
                                } else (i = e.correctIndex(t, r)), (o = e.next(t, n + 1, r));
                                var s = i * n;
                                return { result: e.getBar(i) + o.result, checksum: s + o.checksum };
                            },
                        },
                    ]
                ),
        ...
        (e.getMaximumHeightOfEncodings = function (t) {
            ...
            (e.calculateEncodingAttributes = function (t, e, n) {
                for (var r = 0; r < t.length; r++) {
                    ...
                    (f.width = Math.ceil(Math.max(o, l))), (f.height = a(f, c)), (f.barcodePadding = u(o, l, c));
                }
            }),
    ...
    function (t, e, n) {
        ...
        var p = function () {},
            h = function (t, e, n) {
                ...
                return (
                    ...
                    void 0 !== e && ((n = n || {}).format || (n.format = b()), r.options(n)[n.format](e, n).render()),
                    r
                );
            };
        ...
        function g(t, e) {
            p.prototype[e] = p.prototype[e.toUpperCase()] = p.prototype[e.toLowerCase()] = function (n, r) {
                var i = this;
        ...
        (p.prototype.options = function (t) {
            ...
            (p.prototype.render = function () {
                ...
                if (Array.isArray(this._renderProperties)) for (var t = 0; t < this._renderProperties.length; t++) _(this._renderProperties[t], this._encodings, this._options);
    ...
    function (t, e, n) {
        ...
        function s(t) {
            ...
            if ((t && t.nodeName && "svg" === t.nodeName.toLowerCase()) || ("undefined" != typeof SVGElement && t instanceof SVGElement)) return { element: t, options: (0, o.default)(t), renderer: i.default.SVGRenderer };
                    ...
                    },
                    {
                        ...
                        value: function (t, e) {
                            ...
                            t.displayValue &&
                                ...
                                (o.font = i),
                                "left" == t.textAlign || e.barcodePadding > 0 ? ((n = 0), (o.textAlign = "left")) : "right" == t.textAlign ? ((n = e.width - 1), (o.textAlign = "right")) : ((n = e.width / 2), (o.textAlign = "center")),

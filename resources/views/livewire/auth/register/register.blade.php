...
<div>
    @if (setting('partnersCanRegister', true))
        ...
        <div class="flex items-center min-h-screen md:flex"
            @if ($isUrl) {{-- apply img to background --}}
            {{-- make background image opacity --}}
        ...
        @else
            ...
            <div class="py-4 mx-auto my-10 overflow-y-auto">
                <div {{-- w-11/12 h-full max-w-xl mx-auto my-12 overflow-hidden bg-white rounded-lg shadow-lg shadow-slate-400 md:my-auto md:max-w-2xl --}}
                                ...
                                <div id="tab_wrapper">
                                    ...
                                    <p class="my-4 text-center">
                                        {{ __('Already have an account?') }} <a href="{{ route('login') }}"
                                            class="ml-2 font-bold text-primary-500 text-md">{{ __('Login') }}</a>
                                    </p>
                                </div>
